...
export default function Attractions({ route }) {
    ...
    const Attractions = cityData[selectedCity.name].Attractions;
    

    const filterAttractions = (Attractions) => {
        return Attractions.name.toLowerCase().includes(searchQuery.toLowerCase());
    };

    return (
        <ImageBackground source={require('./Attractions.jpeg')} >
        <View style={{backgroundColor:"transparent"}}>
            ...
            <FlatList
                 data={Attractions.filter(filterAttractions)}
